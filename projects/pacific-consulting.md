...
Their website was running on Shopify, which meant they were paying a monthly ecommerce platform fee to operate a storefront for a company with no products to sell. What they needed instead was a site that explained their services clearly and gave a visitor an obvious way to reach a contact form. They also needed it in two languages, since a number of their clients speak Japanese, so the site has a toggle that switches the whole page between English and Japanese.
